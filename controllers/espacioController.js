...
const obtenerUnicoEspacio = async (req, res) => {
  ...
  .populate({path: "esp_foro", populate: {path: "post_comentarios", populate: {path: "res_creador", select: "-usu_confirmado -usu_password -usu_token -usu_rol -usu_espacios -usu_esp_colaborador -usu_img_id -createdAt -updatedAt -__v"}}})
  .populate({path: "esp_foro", populate: {path: "post_comentarios", populate: {path: "res_comentarios", populate: {path: "res_creador", select: "-usu_confirmado -usu_password -usu_token -usu_rol -usu_espacios -usu_esp_colaborador -usu_img_id -createdAt -updatedAt -__v"}}}});
  res.json(espacio);
}
